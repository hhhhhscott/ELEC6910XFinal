...
class ExtResNetBlock(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=3, num_groups=8, **kwargs):
        ...
        self.conv3 = SingleConv(out_channels, out_channels, kernel_size=kernel_size, num_groups=num_groups,
                                activation=False)
...
class Encode(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, conv_kernel_size=3, pool_kernel_size=(1, 2, 2), num_groups=8,
                 padding=1, pooling=True, **kwargs):
...
class Decode(nn.Module):
    def __init__(self, in_channels, out_channels, conv_kernel_size=3, num_groups=8, scale_factor=(1, 2, 2), padding=1,
                 **kwargs):
        super(Decode, self).__init__()

        self.upsample = nn.ConvTranspose3d(in_channels, out_channels, kernel_size=conv_kernel_size, stride=scale_factor,
                                           padding=padding)
