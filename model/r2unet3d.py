...
class Decode(nn.Module):
    def __init__(self, in_channels, out_channels, conv_kernel_size=3, scale_factor=(1, 2, 2), padding=1, mode="nearest",
        ...
        self.upconv = nn.ConvTranspose3d(in_channels, out_channels, kernel_size=conv_kernel_size, stride=scale_factor,
                                         padding=padding)
...
class R2UNet3D(nn.Module):
    ...
    def __init__(self,
        ...
        self.final_conv = nn.Conv3d(in_channels, num_class, 1)
